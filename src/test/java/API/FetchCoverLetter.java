...
public class FetchCoverLetter extends WbidBasepage {
...
// Step 2: Use the Token as Authorization in the Next API Call
		...
		String fileContentsCoverletter = nextResponse.jsonPath().getString("lstBidDataFiles.FileContent[3]");
		System.out.println("Cover letter is : "+fileContentsCoverletter);
