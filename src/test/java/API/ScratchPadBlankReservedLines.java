...
public class ScratchPadBlankReservedLines extends WbidBasepage {
	...
	public static ArrayList<String> ABCarray = new ArrayList<>();
	public static ArrayList<String> BCarray = new ArrayList<>();
	public static ArrayList<String> ABCDarray = new ArrayList<>();
	public static ArrayList<String> Darray = new ArrayList<>();
	public static ArrayList<String> Reservearray = new ArrayList<>();
	public static ArrayList<String> Blankarray = new ArrayList<>();
...
// Step 2: Use the Token as Authorization in the Next API Call
		...
		String requestBody2 = "{" + "\"Domicile\": \"" + domicile + "\"," + "\"EmpNum\": \"21221\","
				...
				+ "\"Round\": " + expectedRound + "," + "\"secretEmpNum\": \"21221\"," + "\"Version\": \"10.4.16.4\","
...
// Iterate through the keys of "Lines"
		for (String lineKey : linesObject.keySet()) {
			...
			if (lineData.has("FAPositions")) {
				...
				boolean reservedString = lineData.getBoolean("ReserveLine");
				boolean blankString = lineData.getBoolean("BlankLine");
				if (positionsArray.length() > 0) {
					linecount = linecount + positionsArray.length();
					if (positionsArray.length() == 3) {
						ABCarray.add(lineKey);
						ABCcount++;
					...
					linecount++;
					if (reservedString == true) {
						Reservearray.add(lineKey);
						reservecount++;
					}
					if (blankString == true) {
						Blankarray.add(lineKey);
						blankcount++;
					}
				}
		...
		//Collections.sort(ABCarray);
		List<String> sortedLinesABC = ABCarray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		List<String> sortedLinesBC = BCarray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		List<String> sortedLinesABCD = ABCDarray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		List<String> sortedLinesD = Darray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		List<String> sortedLinesReserve = Reservearray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		List<String> sortedLinesBlank = Blankarray.stream()
                .map(Integer::parseInt) // Convert to Integer
                .sorted()               // Sort in ascending order
                .map(String::valueOf)   // Convert back to String
                .collect(Collectors.toList());
		...
		System.out.println("ReserveLines count= " + reservecount);
		System.out.println("BlankLines count= " + blankcount);
		System.out.println("Lines with ABC combination= " + sortedLinesABC);
		System.out.println("Lines count with ABC combination= " + sortedLinesABC.size());
		System.out.println("Lines with BC combination= " + sortedLinesBC);
		System.out.println("Lines count with BC combination= " + sortedLinesBC.size());
		System.out.println("Lines with ABCD combination= " + sortedLinesABCD);
		System.out.println("Lines count with ABCD combination= " + sortedLinesABCD.size());
		System.out.println("Lines with D combination= " + sortedLinesD);
		System.out.println("Lines count with D combination= " + sortedLinesD.size());
		System.out.println("Lines with Reserved true= " + sortedLinesReserve);
		System.out.println("Lines count with Reserved true= " + sortedLinesReserve.size());
		System.out.println("Lines with Blank true= " + sortedLinesBlank);
		System.out.println("Lines count with Blank true= " + sortedLinesBlank.size());
