...
public class LoginTest extends WbidBasepage {
	...
	public void CBW002001000001() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000001)").assignAuthor("VS/483");
	...
	public void CBW002001000002() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000002)").assignAuthor("VS/483");
	...
	public void CBW002001000003() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000003)").assignAuthor("VS/483");
	...
	public void CBW002001000004() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000004)").assignAuthor("VS/483");
	...
	public void CBW002001000005() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000005)").assignAuthor("VS/483");
	...
	public void CBW002001000006() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000006)").assignAuthor("VS/483");
	...
	public void CBW002001000007() {
		logger = WbidBasepage.extent.createTest("LOGIN PAGE (CBW001001000007)").assignAuthor("VS/483");
	...
	public void CBW002001000008() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000008)").assignAuthor("VS/483");
	...
	public void CBW002001000009() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000009)").assignAuthor("VS/483");
	...
	public void CBW002001000010() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000010)").assignAuthor("VS/483");
	...
	public void CBW002001000011() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000011)").assignAuthor("VS/483");
	...
	public void CBW002001000012() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000012)").assignAuthor("VS/483");
	...
	public void CBW002001000013() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000013)").assignAuthor("VS/483");
	...
	public void CBW002001000014() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000014)").assignAuthor("VS/483");
	...
	public void CBW002001000015() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000015)").assignAuthor("VS/483");
	...
	public void CBW002001000016() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000016)").assignAuthor("VS/483");
	...
	public void CBW002001000017() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000017)").assignAuthor("VS/483");
	...
	public void CBW002001000018() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000018)").assignAuthor("VS/483");
	...
	public void CBW002001000019() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000019)").assignAuthor("VS/483");
	...
	public void CBW002001000020() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000020)").assignAuthor("VS/483");
	...
	public void CBW002001000021() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000021)").assignAuthor("VS/483");
	...
	public void CBW002001000022() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000022)").assignAuthor("VS/483");
	...
	public void CBW002001000023() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000023)").assignAuthor("VS/483");
	...
	public void CBW002001000024() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000024)").assignAuthor("VS/483");
	...
	public void CBW002001000025() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000025)").assignAuthor("VS/483");
	...
	public void CBW002001000026() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000026)").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW002001000027() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000027)").assignAuthor("VS/483");
	...
	public void CBW002001000028() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000028)").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW002001000029() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000029)").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW002001000030() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000030)").assignAuthor("VS/483");
	...
	public void CBW002001000031() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000031)").assignAuthor("VS/483");
	...
	public void CBW002001000032() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000032)").assignAuthor("VS/483");
	...
	public void CBW002001000033() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000033)").assignAuthor("VS/483");
	...
	public void CBW002001000034() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000034)").assignAuthor("VS/483");
	...
	public void CBW002001000035() throws Exception {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000035)").assignAuthor("VS/483");
	...
	public void CBW002001000036() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000036)").assignAuthor("VS/483");
	...
	public void CBW002001000037() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000037)").assignAuthor("VS/483");
	...
	public void CBW002001000038() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000038)").assignAuthor("VS/483");
	...
	public void CBW002001000039() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000039)").assignAuthor("VS/483");
	...
	public void CBW002001000040() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000040)").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW002001000041() {
		logger = WbidBasepage.extent.createTest(" LOGIN PAGE (CBW001001000041)").assignAuthor("VS/483");
