...
public class TAFBLineFATest extends WbidBasepage{
	...
	public void CBW0100020000029() {
		...
		Assert.assertTrue(objTafb.getAllTAFBAndCompare(FABIDCalculation.tafbMapNew));
	...
	public void CBW0100020000030() throws Throwable {
		...
		TAFB_FA.fetchTafb(domicile, APIRound, position, APIMonth); //API	Assertion calculation part 
	}
