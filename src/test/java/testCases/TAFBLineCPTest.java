...
public class TAFBLineCPTest extends WbidBasepage{
	...
	public void CBW010002000001() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200001").assignAuthor("VS/483");
	...
	public void CBW010002000002() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200002").assignAuthor("VS/483");
	...
	public void CBW010002000003() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200003").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW010002000004() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200004").assignAuthor("VS/483");
	...
	public void CBW010002000005() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200005").assignAuthor("VS/483");
	...
	public void CBW010002000006() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200006").assignAuthor("VS/483");
	...
	public void CBW010002000007() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200007").assignAuthor("VS/483");
		logger.info("Verify user can able to select any condition  Assert: Download button is enabled");
	...
	public void CBW010002000008() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200008").assignAuthor("VS/483");
	...
	public void CBW010002000009() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW01000200009").assignAuthor("VS/483");
	...
	public void CBW0100020000010() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000010").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100020000011() throws Exception {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000011").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100020000012() throws JsonProcessingException {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000012").assignAuthor("VS/483");
	...
	public void CBW0100020000013() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000013").assignAuthor("VS/483");
	...
	public void CBW0100020000014() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000014").assignAuthor("VS/483");
	...
	public void CBW0100020000015() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000015").assignAuthor("VS/483");
	...
	public void CBW0100020000016() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000016").assignAuthor("VS/483");
	...
	public void CBW0100020000017() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000017").assignAuthor("VS/483");
	...
	public void CBW0100020000018() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000018").assignAuthor("VS/483");
	...
	public void CBW0100020000019() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000019").assignAuthor("VS/483");
	...
	public void CBW0100020000020() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000020").assignAuthor("VS/483");
	...
	public void CBW0100020000021() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000021").assignAuthor("VS/483");
	...
	@Test(priority = 22, dependsOnMethods = { "CBW0100020000011" })
	public void CBW0100020000022() throws JsonProcessingException, ParseException {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000022").assignAuthor("VS/483");
		logger.info(
...
//		Assert.assertTrue(objCommon.getAllTripDataAndCompare(FetchDates.tripData));
	...
	@Test(priority = 23, dependsOnMethods = { "CBW0100020000011" })
	public void CBW0100020000023() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000023").assignAuthor("VS/483");
	...
	@Test(priority = 24, dependsOnMethods = { "CBW0100020000011" })
	public void CBW0100020000024() throws Throwable {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000024").assignAuthor("VS/483");
		logger.info("check whether the Grnd  hours showing correctly or not  ");
		
		//GrndHour.fetchApiData(domicile, APIRound, position, APIMonth);//API
		
		GroundTest.fetchground(domicile, APIRound, position, APIMonth);//API
		
//		Assert.assertTrue(objInCred.IndividualCredCompareAPI(), "cred not same as API cred ");
	}

	@Test(priority = 25, dependsOnMethods = { "CBW0100020000011" })
	public void CBW0100020000025() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000025").assignAuthor("VS/483");
		logger.info("check whether the individual \"Blk \" hours showing correctly or not  ");
		logger.info("Assert: Grnd hours meets the condition and should be same as its in the trip file  ");
//		objTAFB.getGrndHour(); get grnd hr
//		objTAFB.getGrndHrCompare();
		Assert.assertTrue(objTAFB.getGrndHrCompare(), "Grnd hr Mismatch");
			
		}

	@Test(priority = 26, dependsOnMethods = { "CBW0100020000011" })
	public void CBW0100020000026() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000026").assignAuthor("VS/483");
		driver.navigate().refresh();
		objwait.waitS(7000);
	logger.info("check whether the total blk hours for each day is showing correctly or not  ");
		
	}

	@Test(priority = 27, enabled = true)
	public void CBW0100020000027() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000027").assignAuthor("VS/483");
		logger.info("check whether the total blk hours for the trip  is showing correctly or not ");
//		Assert.assertTrue(objInCred.ReserveLinesPMCred(), "cred not same as 600 for CP and FO");
	...
	public void CBW0100020000028() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000028").assignAuthor("VS/483");
		logger.info("check whether the total blk hours for the trip  is showing correctly or not ");
		logger.info("Assert: otal blk hours for a trip is shown as the sum of  blk hours of each day   should be same as its in the trip file ");

	}
	@Test(priority = 29, enabled = true)
	public void CBW0100020000029() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000029").assignAuthor("VS/483");
	...
	public void CBW0100020000030() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000030").assignAuthor("VS/483");
		logger.info("Verify the TAFB shown inside the trip data is correct or not ");
		logger.info("Assert: The TAFB displayed inside the trip details meets the calculations  and should be same as its in the wbp file");
	...
	public void CBW0100020000032() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000032").assignAuthor("VS/483");
	...
	public void CBW0100020000033() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000033").assignAuthor("VS/483");
		...
		logger.info("Assert : blue tick on the TAFB parameter");

	}
	@Test(priority = 34, enabled = true)
	public void CBW0100020000034() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000034").assignAuthor("VS/483");
	...
	public void CBW0100020000035() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000035").assignAuthor("VS/483");
		logger.info("Verify the TAFB parameter  showing Zero in case of reserve trips ");
		logger.info("Assert the value shows in the parameter is Zero and same as its in the file from the server  (WBL File)");

	}
	@Test(priority = 36, enabled = true)
	public void CBW0100020000036() {
		logger = WbidBasepage.extent.createTest("BNA-CP-Round 1-TAFB of each Line - CBW010002000036").assignAuthor("VS/483");
		logger.info("Verify the TAFB parameter  showing Zero in case of blank lines ");
		logger.info("Assert the TAFB parameter showing zero in blank lines and same as its in the file from the server (WBL File)");
