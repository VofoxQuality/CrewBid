...
public class TAFBLineCP_ATL extends WbidBasepage{
	...
	public void CBW010002000001() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200001").assignAuthor("VS/483");
	...
	public void CBW010002000002() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200002").assignAuthor("VS/483");
	...
	public void CBW010002000004() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200004").assignAuthor("VS/483");
	...
	public void CBW010002000005() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200005").assignAuthor("VS/483");
	...
	public void CBW010002000006() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200006").assignAuthor("VS/483");
	...
	public void CBW010002000007() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200007").assignAuthor("VS/483");
		logger.info("Verify user can able to select any condition  Assert: Download button is enabled");
	...
	public void CBW010002000008() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200008").assignAuthor("VS/483");
	...
	public void CBW010002000009() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW01000200009").assignAuthor("VS/483");
	...
	public void CBW0100020000010() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000010").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100020000011() throws Exception {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000011").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100020000012() throws JsonProcessingException {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000012").assignAuthor("VS/483");
	...
	public void CBW0100020000013() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000013").assignAuthor("VS/483");
	...
	public void CBW0100020000014() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000014").assignAuthor("VS/483");
	...
	public void CBW0100020000015() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000015").assignAuthor("VS/483");
	...
	public void CBW0100020000016() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000016").assignAuthor("VS/483");
	...
	public void CBW0100020000017() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000017").assignAuthor("VS/483");
	...
	public void CBW0100020000018() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000018").assignAuthor("VS/483");
	...
	public void CBW0100020000019() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000019").assignAuthor("VS/483");
	...
	public void CBW0100020000022() throws JsonProcessingException, ParseException {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000022").assignAuthor("VS/483");
		logger.info(
	...
	public void CBW0100020000023() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000023").assignAuthor("VS/483");
	...
	public void CBW0100020000024() throws Throwable {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000024").assignAuthor("VS/483");
...
//		GroundTest.fetchground(domicile, APIRound, position, APIMonth);//API
	...
	public void CBW0100020000025() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000025").assignAuthor("VS/483");
		driver.navigate().refresh();
		objwait.waitS(7000);
...
//		Assert.assertTrue(objTAFB.getGrndHrCompare(), "Grnd hr Mismatch");//API Assertion
		}
	...
	public void CBW0100020000027() throws Throwable {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000027").assignAuthor("VS/483");
...
//		Assert.assertTrue(objTafb.getAllTAFBAndCompare(TrialBidAPI.tafbMapNew));
	...
	public void CBW0100020000034() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000034").assignAuthor("VS/483");
	...
	public void CBW0100020000035() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000035").assignAuthor("VS/483");
	...
	public void CBW0100020000036() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-TAFB of each Line - CBW010002000036").assignAuthor("VS/483");
