...
public class IndividualCredValueTest extends WbidBasepage {
	...
	public void CBW010003000001() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300001").assignAuthor("VS/483");
	...
	public void CBW010003000002() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300002").assignAuthor("VS/483");
	...
	public void CBW010003000003() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300003").assignAuthor("VS/483");
	...
	public void CBW010003000004() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300004").assignAuthor("VS/483");
	...
	public void CBW010003000005() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300005").assignAuthor("VS/483");
	...
	public void CBW010003000006() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300006").assignAuthor("VS/483");
	...
	public void CBW010003000007() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300007").assignAuthor("VS/483");
		logger.info("Verify user can able to select any condition  Assert: Download button is enabled");
	...
	public void CBW010003000008() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300008").assignAuthor("VS/483");
	...
	public void CBW010003000009() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW01000300009").assignAuthor("VS/483");
	...
	public void CBW0100030000010() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000010").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100030000011() throws Exception {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000011").assignAuthor("VS/483");
		if (isDownloadSuccessful) {
	...
	public void CBW0100030000013() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000013").assignAuthor("VS/483");
	...
	public void CBW0100030000014() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000014").assignAuthor("VS/483");
	...
	public void CBW0100030000015() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000015").assignAuthor("VS/483");
	...
	public void CBW0100030000016() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000016").assignAuthor("VS/483");
	...
	public void CBW0100030000017() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000017").assignAuthor("VS/483");
	...
	public void CBW0100030000018() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000018").assignAuthor("VS/483");
	...
	public void CBW0100030000022() throws JsonProcessingException, ParseException {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000022").assignAuthor("VS/483");
		logger.info(
...
//		Assert.assertTrue(objCommon.getAllTripDataAndCompare(FetchDates.tripData));
	...
	public void CBW0100030000023() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000023").assignAuthor("VS/483");
	...
	public void CBW0100030000025() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000025").assignAuthor("VS/483");
	...
	public void CBW0100030000026() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000026").assignAuthor("VS/483");
		driver.navigate().refresh();
		objwait.waitS(7000);
		logger.info(
	...
	public void CBW0100030000028() {
		logger = WbidBasepage.extent.createTest("ATL-CP-Round 1-Individual Cred Value Page - CBW010003000028").assignAuthor("VS/483");
		logger.info(
